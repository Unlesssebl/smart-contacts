...
Получить текущий маппинг OU -> Название организации и цвет тега. **Доступ**: IT-Operator.
...
Обновить маппинг OU -> Название организации и цвет тега. После обновления маппинга запускается фоновая задача (background task), которая обновляет поле `organization` у всех существующих пользователей. **Доступ**: IT-Operator.
